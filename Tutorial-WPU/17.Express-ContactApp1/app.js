...
const {loadContact, findByName} = require('./utils/contacts.js')
...
app.get('/kontak', (req, res) => {
    res.render('contacts',{
        judul:'halaman contacts',
        layout:'layouts/main-layouts',
        contacts: loadContact(), //dioper ke view
    });
});


app.get('/kontak/:nama_nya', (req, res) => {
    const namaewa = req.params.nama_nya;
    res.render('detail',{
        judul:'halaman contacts',
        layout:'layouts/main-layouts',
        contact: findByName(namaewa), //dioper ke view
    });
    // console.log(findByName(namae));
});
